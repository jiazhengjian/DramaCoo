...
> [!NOTE]
> This repository also keeps **DramaCoo**, but **FilmAgent is an independent legacy research project** from the lab. It is preserved here for archival and reproducibility purposes only. FilmAgent does not depend on DramaCoo, and DramaCoo does not call FilmAgent.
>
